...
export const SecretoNeptuno = () => {
  ...
  return (
    <PlantillaSecreto
      titulo="El dedo de Neptuno"
      descripcion="La Fuente de Neptuno es famosa no sólo por su belleza, 
      sino también por un curioso efecto óptico. Poniéndose cerca de la 
      entrada de la biblioteca Salaborsa, de hecho, el dedo de Neptuno parece 
      transformarse mágicamente en un falo. Se dice que este juego de perspectivas 
      fue voluntad del artista que lo esculpió, Juan de Bolonia, en señal de protesta 
      contra la censura que había sufrido."
